...
const Sidepan = ()  =>{
  ...
  {/* <div data-position="right" className="side-bar"> */}
    ...
    <img src="https://cdn-icons-png.flaticon.com/128/329/329350.png" style={{ height:"37px",width:"30px",alignSelf:"flex-end"}}/></Link>
    </div>
...
<meta charSet="utf-8" />
  ...
  >
    <div className="container">
      <div className="navbar-header">
        ...
        <a className="navbar-brand" href="#"><br></br><br></br><br></br>HOMEHELPER
      ...
      <div className="collapse navbar-collapse" style={{ color:"black" }}>
        <ul className="nav navbar-nav" style={{ textAlign:"left",color:"black"  }}>
      ...
      /> </a> */}<br></br><br></br><a href="https://coimbatore.nic.in/helpline/" target="_blank" rel="noopener noreferrer" style={{ color:"black" }}>
     
   Emergency</a>
          </li>
          <li>
            {/* <a href="#about"><br></br><Link to="/progress"><img
        src="https://cdn-icons-png.flaticon.com/128/7048/7048019.png"
        alt="Portrait of Mr. Roboto"
        className="profile-image" style={{ height:"50px" }} 
      /></Link></a>*/}<Link to="/progress" style={{ color:"black" }} ><br></br><br></br>Progress</Link>
          </li><li>
          <Link to="/feedform"><br></br><br></br>Feedform</Link></li><li></li><li></li><li></li><li></li><li></li>
          {/* <li>
            <a href="#portfolio"><br></br><img
        src="https://cdn-icons-png.flaticon.com/128/1946/1946429.png"
        alt="Portrait of Mr. Roboto"
        className="profile-image" style={{ height:"50px",width:"50px" }} 
      /></a>
          </li> */}
          <li></li>
          <li>
            {/* <a href="#contact">*/}<br></br><br></br><Link to="/signup">Logout</Link><br></br><br></br><br></br>
          </li>
          <li><Link to="/sidepan"><br></br><br></br>
          <img
        src="https://cdn-icons-png.flaticon.com/128/148/148795.png"
        alt="Portrait of Mr. Roboto"
        className="profile-image" style={{ height:"25px" }} 
      /></Link>    
          </li>
        </ul>
  ...
  <div className="container-fluid splash" id="splash">
    <div className="container">
      ...
      /> */}
      {/* <h1 style={{color:"black",fontSize:"30px" }}><br></br><br></br><br></br>Welcome!
